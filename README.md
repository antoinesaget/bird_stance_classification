...
```bash
make bootstrap
./.venv/bin/birdsys labelstudio ...
./.venv/bin/birdsys datasets ...
./.venv/bin/birdsys backend ...
./.venv/bin/birdsys experiment ...
```

After the editable install is in place, the shorter form is available too:
