...
from birdsys.training.model_b_artifacts import DEFAULT_LABELS, HEADS, LoadedModelBArtifact, LoadedModelBMember
...
def test_attribute_predictor_stitches_specialist_bundle(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        "services.ml_backend.app.predictors.model_b_attributes.load_model_b_artifact",
