...
from birdsys.training.model_b_evaluation import EvaluationDiagnostics, EvaluationResult
from scripts.evaluate_model_b_checkpoint import main
...
def test_evaluate_model_b_checkpoint_accepts_artifact_directory(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "scripts.evaluate_model_b_checkpoint.evaluate_checkpoint_on_dataset",
    ...
    monkeypatch.setattr(
        ...
        "argv",
        [
            "evaluate_model_b_checkpoint.py",
            "--checkpoint",
            str(artifact_dir),
            "--dataset-dir",
            str(dataset_dir),
