"""Purpose: Provide shared helpers for versioned report directories and numeric comparisons."""
...
def diff_numeric_dict(current: dict[str, Any], previous: dict[str, Any]) -> dict[str, float]:
    out: dict[str, float] = {}
