...
from birdsys.core.model_b_artifacts import HEADS, load_model_b_artifact
...
def test_load_model_b_artifact_accepts_legacy_checkpoint_dir(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    monkeypatch.setattr("birdsys.core.model_b_artifacts.MultiHeadAttributeModel", DummyModel)
